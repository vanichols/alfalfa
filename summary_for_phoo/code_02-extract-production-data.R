#--process all production data to be standardized format units
...
# 0. read in data ---------------------------------------------------------
  ...
  d <- 
    ...
    #--extract stand life to be used in other calcs
...
#--write it to use
  p_all %>% write_csv("summary_for_phoo/tulare-scenario-notouch-production-data.csv")
