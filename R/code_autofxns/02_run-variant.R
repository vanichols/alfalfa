#--use monster functions to run different variants
...
ProcProdData <- function(my_variant = "v0001", my_uncertainty = "u0001"){
  ...
  d_raw <- read_csv(paste0("R/code_autofxns/datain/", my_variant, ".csv"),
                    skip = 5) %>% 
