...
## [Hauschild 2012](https://link.springer.com/article/10.1007/s11367-012-0489-5)

Characterization factors - convert flow to impact
...
![](images/image-1353806009.png)

Visualizing contributions to the GHG footprint of alfalfa. Sankey/Alluvial diagrams, with the color of the flow based on the uncertainty (or maybe in my case the variability; [Paoli 2017](https://www.sciencedirect.com/science/article/pii/S1876610217359106)):

![](images/image-1956153384.png)

## Fuel emission factors

Super confused. [EPA emission factors](https://www.epa.gov/climateleadership/ghg-emission-factors-hub) (which is what FTM uses) have a table that says 'mobile combustion CO2':

![](images/image-1102276560.png)
...
The chemical formula for diesel is C~12~H~23~ and the molecular weight of C is 12, H is 1.

```{r}
#Total molecular weight of diesel
tot <- (12*12 + 23 * 1)
# fraction of diesel molecule that is carbon
frac_c <- (12 * 12)/ tot
...
```{r}
#--in kg of CO2
round(0.005 * (44/28) * 298, 2)
#--in Mg of CO2
round(0.005 * (44/28) * 298, 2)/1000
```
